# tlframe ![](reference/figures/logo.png)

> Regulatory-grade clinical tables, listings, and figures in RTF and PDF
> from a single specification.

**tlframe** is an R package for pharmaceutical submissions. You describe
the output once; tlframe renders both RTF and PDF — change the file
...
r2rtf). **tlframe occupies a different position**: it is a native
...
| Inline markup | [`fr_super()`](https://vthanik.github.io/tlframe/reference/fr_super.md), [`fr_bold()`](https://vthanik.github.io/tlframe/reference/fr_bold.md), [`fr_italic()`](https://vthanik.github.io/tlframe/reference/fr_italic.md), [`fr_dagger()`](https://vthanik.github.io/tlframe/reference/fr_dagger.md) in any cell |
...
tlframe ships with synthetic CDISC ADaM datasets so every example runs
out of the box.
...
doesn’t matter — tlframe resolves everything at render time.

| Verb | Purpose |
|----|----|
| [`fr_table()`](https://vthanik.github.io/tlframe/reference/fr_table.md) / [`fr_listing()`](https://vthanik.github.io/tlframe/reference/fr_listing.md) / [`fr_figure()`](https://vthanik.github.io/tlframe/reference/fr_figure.md) | Entry points — create spec from data or plot (figures support a list of plots with per-page metadata tokens) |
| [`fr_cols()`](https://vthanik.github.io/tlframe/reference/fr_cols.md) + [`fr_col()`](https://vthanik.github.io/tlframe/reference/fr_col.md) | Column labels, widths, alignment, visibility, N-counts |
| [`fr_header()`](https://vthanik.github.io/tlframe/reference/fr_header.md) | Header styling (bold, align, valign, colors) |
| [`fr_titles()`](https://vthanik.github.io/tlframe/reference/fr_titles.md) | Table titles (1-4 lines, with inline markup) |
| [`fr_footnotes()`](https://vthanik.github.io/tlframe/reference/fr_footnotes.md) | Footnotes with placement control (`"every"` or `"last"`) |
| [`fr_rows()`](https://vthanik.github.io/tlframe/reference/fr_rows.md) | `group_by`, `group_label`, `group_keep`, `page_by`, `indent_by` (multi-level), `blank_after`, `sort_by`, `repeat_cols`, `wrap` |
| [`fr_page()`](https://vthanik.github.io/tlframe/reference/fr_page.md) | Paper size, orientation, margins, font, continuation text |
| [`fr_pagehead()`](https://vthanik.github.io/tlframe/reference/fr_pagehead.md) / [`fr_pagefoot()`](https://vthanik.github.io/tlframe/reference/fr_pagefoot.md) | Running headers/footers with token substitution |
| [`fr_hlines()`](https://vthanik.github.io/tlframe/reference/fr_hlines.md) / [`fr_vlines()`](https://vthanik.github.io/tlframe/reference/fr_vlines.md) / [`fr_grid()`](https://vthanik.github.io/tlframe/reference/fr_grid.md) | Horizontal/vertical rules (8 presets) |
| [`fr_spans()`](https://vthanik.github.io/tlframe/reference/fr_spans.md) | Spanning column headers |
| [`fr_styles()`](https://vthanik.github.io/tlframe/reference/fr_styles.md) | Cell/row/column conditional formatting |
| [`fr_spacing()`](https://vthanik.github.io/tlframe/reference/fr_spacing.md) | Gaps between structural sections |
| [`fr_render()`](https://vthanik.github.io/tlframe/reference/fr_render.md) | Render to RTF, PDF, or LaTeX |
...
tlframe writes output directly — no intermediate HTML, gt, or huxtable
layer:
...
- **PDF**: Generates tabularray LaTeX, compiles with XeLaTeX. Falls back
  to Latin Modern fonts (built into tinytex) on Linux/Docker without
  Microsoft fonts. Set `TLFRAME_FONT_DIR` to a directory of
...
- **[Get
  Started](https://vthanik.github.io/tlframe/articles/tlframe.html)** —
  Your first table to production-ready output
- **[Columns &
  Headers](https://vthanik.github.io/tlframe/articles/columns-and-headers.html)**
  — Widths, alignment, N-counts, decimal alignment
- **[Titles &
  Footnotes](https://vthanik.github.io/tlframe/articles/titles-and-footnotes.html)**
  — Titles, footnotes, inline markup
- **[Rows & Page
  Layout](https://vthanik.github.io/tlframe/articles/rows-and-pages.html)**
  — Grouping, pagination, page chrome
- **[Rules, Spans &
  Styles](https://vthanik.github.io/tlframe/articles/styling.html)** —
  Borders, spanning headers, conditional formatting
- **[Table
  Cookbook](https://vthanik.github.io/tlframe/articles/table-cookbook.html)**
  — 8 complete ICH E3 table programs
- **[Listings &
  Figures](https://vthanik.github.io/tlframe/articles/listings-and-figures.html)**
  — Patient listings and embedded figures
- **[Automation &
  Batch](https://vthanik.github.io/tlframe/articles/automation.html)** —
  Themes, recipes, YAML config, batch rendering
- **[Architecture](https://vthanik.github.io/tlframe/articles/architecture.html)**
...
- **[Tplyr](https://atorus-research.github.io/Tplyr/)** /
  **[rtables](https://insightsengineering.github.io/rtables/)** —
  Analysis table summarization (upstream of tlframe)
