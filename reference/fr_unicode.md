...
| μ | `0x03BC` | Mu (mean) |
| † | `0x2020` | Dagger (use [`fr_dagger()`](https://vthanik.github.io/tlframe/reference/fr_dagger.md)) |
| ‡ | `0x2021` | Double dagger (use [`fr_ddagger()`](https://vthanik.github.io/tlframe/reference/fr_ddagger.md)) |
