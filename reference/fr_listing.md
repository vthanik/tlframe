...
## Listing defaults (vs [`fr_table()`](https://vthanik.github.io/tlframe/reference/fr_table.md))

|  |  |  |
|----|----|----|
| Setting | [`fr_table()`](https://vthanik.github.io/tlframe/reference/fr_table.md) | `fr_listing()` |
...
#> Page: landscape letter, 8pt Courier New
